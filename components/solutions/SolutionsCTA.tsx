    ...
    <section className="relative section overflow-hidden bg-rich">
      ...
      <div className="container-brand relative z-10">
        ...
        >
          ...
          <p className="text-[17px] text-white/45 leading-[1.7] max-w-[480px] mx-auto mb-12">
            Every brand is different. Let us help you find the right approach for your specific goals, audience, and budget.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a
              href={`https://wa.me/${WHATSAPP_NUMBER}?text=Hi%20BrandBazar%2C%20I%20need%20help%20choosing%20the%20right%20solution`}
              target="_blank"

...
const products: Product[] = [
  { id: 1, name: "Classic White Ceramic Mug", category: "Drinkware", type: "mug", tagline: "Dishwasher safe · 11oz · Full wrap print available", price: "₹149", minUnits: "Min. 25 units", badge: "BESTSELLER", tags: ["Bulk Ready", "Logo Print", "Express"], color: "#E85D4A", popularity: 98, slug: "classic-white-ceramic-mug" },
  { id: 2, name: "Magic Color-Changing Mug", category: "Drinkware", type: "mug-magic", tagline: "Heat-activated reveal · 11oz · Stunning brand impact", price: "₹249", minUnits: "Min. 25 units", badge: "NEW", tags: ["Heat Reactive", "Logo Print"], color: "#7C83DB", popularity: 85, isNew: true, slug: "magic-color-changing-mug" },
  { id: 3, name: "Premium Cotton Round Neck T-Shirt", category: "Apparel", type: "tshirt", tagline: "All-over sublimation · S–3XL · Vivid fade-proof colors", price: "₹299", minUnits: "Min. 50 units", badge: "CORPORATE PICK", tags: ["Full Print", "Team Wear"], color: "#1A73E8", popularity: 92, slug: "premium-cotton-round-neck-tshirt" },
  { id: 4, name: "Dry-Fit Performance T-Shirt", category: "Apparel", type: "tshirt", tagline: "Moisture-wicking · Sublimation-ready · Sports & events", price: "₹349", minUnits: "Min. 25 units", tags: ["Dry-Fit", "Premium"], color: "#34A853", popularity: 78, slug: "dry-fit-performance-tshirt" },
  { id: 5, name: "PVC ID Card", category: "Corporate Kits", type: "idcard", tagline: "CR80 standard · Dual-sided print · Professional finish", price: "₹49", minUnits: "Min. 100 units", badge: "BESTSELLER", tags: ["Bulk Ready", "Fast Print"], color: "#7C83DB", popularity: 95, slug: "pvc-id-card" },
  { id: 6, name: "ID Card with Lanyard Set", category: "Corporate Kits", type: "idcard", tagline: "Complete badge + lanyard combo · Full-color print", price: "₹99", minUnits: "Min. 50 units", tags: ["Combo", "Full Print"], color: "#EA4335", popularity: 70, slug: "id-card-lanyard-set" },
  { id: 7, name: "Classic Baseball Cap", category: "Apparel", type: "cap", tagline: "6-panel · Embroidery-ready · Adjustable buckle strap", price: "₹199", minUnits: "Min. 25 units", badge: "CORPORATE PICK", tags: ["Embroidery", "Adjustable"], color: "#3C4043", popularity: 82, slug: "classic-baseball-cap" },
  { id: 8, name: "Premium Snapback Cap", category: "Apparel", type: "cap", tagline: "Flat brim · 3D puff embroidery · Premium finish", price: "₹249", minUnits: "Min. 25 units", badge: "NEW", tags: ["Snapback", "3D Embroidery"], color: "#FBBC04", popularity: 88, isNew: true, slug: "premium-snapback-cap" },
  { id: 9, name: "A5 Hardcover Notebook", category: "Desk & Office", type: "notebook", tagline: "A5 · 192 pages · Debossed cover with custom inner pages", price: "₹179", minUnits: "Min. 50 units", tags: ["Deboss", "Custom Pages"], color: "#D63031", popularity: 74, slug: "a5-hardcover-notebook" },
  { id: 10, name: "A5 Softcover Notebook", category: "Desk & Office", type: "notebook", tagline: "A5 · 160 pages · Full-color printed cover", price: "₹129", minUnits: "Min. 50 units", tags: ["Full Print", "Lightweight"], color: "#5F6368", popularity: 65, slug: "a5-softcover-notebook" },
];

...
export default function RightPanel({
  ...
  return (
    <div className="w-[300px] border-l bg-white flex flex-col overflow-y-auto shrink-0 hidden lg:flex" style={{ borderColor: "#DADCE0" }}>
      {/* Layer Properties */}
      {selectedLayer ? (
          ...
          <div>
            ...
            <div className="flex items-center gap-2">
              <Slider
                ...
                className="flex-1"
              />
              <span className="text-xs w-8 text-right" style={{ color: "#5F6368" }}>
            ...
            <>
              ...
              <div>
                ...
                <div className="flex items-center gap-2">
                  <input
                    type="color"
                    value={selectedLayer.fontColor || "#202124"}
              ...
              {selectedLayer.textEffect === "curved" && (
                <div>
                  ...
                  <Slider
                    value={[selectedLayer.curveRadius || 200]}
              ...
              {selectedLayer.imageUrl && (
                <div className="rounded-lg overflow-hidden border" style={{ borderColor: "#DADCE0" }}>
                  <img
                    ...
                    alt="Layer preview"
                    className="w-full h-24 object-contain bg-[#F8F9FA]"
                  />
                </div>
              )}
                ...
                <div className="flex gap-1.5 flex-wrap">
                  {presetColors.map((c) => (
                    <button
                      ...
                      style={{
                        backgroundColor: c,
                        borderColor: selectedLayer.fillColor === c ? "#1A73E8" : "#DADCE0",
            ...
            [...currentViewLayers].reverse().map((layer) => {
              ...
              return (
                <div
                  ...
                  style={{
                    backgroundColor: layer.id === selectedLayer?.id ? "#E8F0FE" : "transparent",
                  }}
                >
                  ...
                  >
                    {layer.visible ? (
                      ...
                      <EyeOff className="w-3.5 h-3.5" style={{ color: "#9AA0A6" }} />
                    )}
                  </button>
                  <button
                    onClick={(e) => {
                  ...
                  >
                    {layer.locked ? (
                      <Lock className="w-3.5 h-3.5" style={{ color: "#F5A623" }} />
                    ) : (
                      <Unlock className="w-3.5 h-3.5" style={{ color: "#9AA0A6" }} />
                    )}
                  </button>
                  <button
                    onClick={(e) => {

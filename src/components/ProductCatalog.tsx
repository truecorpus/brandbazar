...
const products: Product[] = [
  { name: "Custom Mugs", tagline: "Sip in style with your brand", price: "₹149", imageKey: "mug", categories: ["All", "Corporate", "Gifting"], badge: { label: "Bestseller", variant: "bestseller" }, accent: "217 91% 50%" },
  { name: "Branded T-Shirts", tagline: "Wearable identity for your team", price: "₹299", imageKey: "tshirt", categories: ["All", "Corporate", "Apparel"], accent: "142 71% 45%" },
  { name: "Employee ID Cards", tagline: "Professional badges, instant credibility", price: "₹49", imageKey: "idcard", categories: ["All", "Corporate"], badge: { label: "Bestseller", variant: "bestseller" }, accent: "346 77% 50%" },
  { name: "Embroidered Caps", tagline: "Top-notch brand visibility", price: "₹199", imageKey: "cap", categories: ["All", "Apparel", "Accessories"], accent: "262 60% 55%" },
  { name: "Custom Lamps", tagline: "Light up your workspace, your way", price: "₹499", imageKey: "lamp", categories: ["All", "Gifting"], badge: { label: "New", variant: "new" }, accent: "36 100% 49%" },
  { name: "Branded Notebooks", tagline: "Every page carries your mark", price: "₹129", imageKey: "notebook", categories: ["All", "Corporate", "Gifting"], accent: "15 80% 55%" },
  { name: "Logo Keychains", tagline: "Small gift, lasting impression", price: "₹59", imageKey: "keychain", categories: ["All", "Accessories", "Gifting"], accent: "190 80% 42%" },
  { name: "Corporate Welcome Kits", tagline: "Onboard with impact", price: "₹999", imageKey: "kit", categories: ["All", "Corporate"], accent: "220 9% 20%" },
];
      ...
      <div className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {filtered.map((product) => (
            <div
              key={product.name}
              className="group bg-background rounded-2xl border border-border overflow-hidden flex flex-col transition-all duration-300 hover:border-primary/30 hover:-translate-y-1"

...
export const alt = 'BrandBazar Solutions';
...
export default async function Image({ params }: { params: { slug: string } }) {
  ...
  const title = solution?.name ?? 'BrandBazar';
  const label = solution?.category ?? 'BrandBazar Solutions';
  const subheadline = solution?.headline ?? 'Premium Corporate Branding & Merchandise Solutions';
